...
const translations = {
  en: {
    ...
    "home.customText": "Make celebrations extra special. Give us the blueprint for what the cake needs to reflect & let us make your precise dream a reality.",
...
function renderProducts(productsList) {
  ...
  productsList.forEach(product => {
    ...
    // Dynamic naming handling for database (translates if nameKey exists, otherwise uses freeform name)
